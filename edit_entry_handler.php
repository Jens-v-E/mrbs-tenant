...
// Multi-Tenant: Tenant immer aus Session übernehmen
$entry['tenant_id'] = (int)($_SESSION['tenant_id'] ?? 0);

// Safety: wenn Tenant fehlt → Fehler statt 0
if ($entry['tenant_id'] === 0) {
    throw new Exception("Tenant-ID fehlt. Bitte erneut anmelden.");
}
...
foreach ($rooms as $room_id)
{
  ...
  // Multi-Tenant: tenant_id IMMER setzen
  $booking['tenant_id'] = (int)($_SESSION['tenant_id'] ?? 0); 
